...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ============================================================
    // ✅ IP + User-Agent (para logs / trazabilidad)
    // ============================================================
    const forwarded = req.headers['x-forwarded-for'];
    const socketIp = req.socket?.remoteAddress;
    let rawIp = forwarded?.split(',')[0]?.trim() || socketIp;

    // Normalizaciones típicas localhost
    ...
    const isValidPublicIp =
      ...
      !rawIp.startsWith('172.') &&           // ojo: simplificado a tu versión original
    ...
    const sheetPayload = {
      ...
      // ✅ GEO: ahora es la fuente de verdad
      geo_city: geo_city || '',
    ...
    // ============================================================
    // ✅ Enviar a tu Apps Script / endpoint de Sheets
    // ============================================================
